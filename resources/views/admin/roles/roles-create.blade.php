...
<form action="{{ route('admin.roles.create') }}" method="post">
    ...
    <div class="card">
        <div class="border-bottom card-header">
            <h4 class="card-title">{{ trans('general.Create Role') }}</h4>
            <div>
            ...
            <div class="row pt-2">
                <div class=" col-12">
                    <div class="mb-1">
                        ...
                        <input required type="text" name="title" class="form-control" id="title" placeholder="Admin" value="{{old('title')? old('title') : ''}}">
                    </div>
                </div>
                ...
                <div class=" col-12">
                    <div class="mb-1">
                        ...
                        <textarea required name="description" id="description" class="form-control" rows="4">{{old('description')? old('description') : ''}}</textarea>
                    </div>
                </div>
                    ...
                    <div class="card shadow-none bg-transparent">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="permissions[]" type="checkbox" id="permission-check-{{$permission->id}}" value="{{$permission->id}}">
