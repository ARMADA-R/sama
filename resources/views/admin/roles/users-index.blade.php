        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">{{ trans("general.Users and Accounts") }}</h4>
                    <a href="{{ route('admin.users.create') }}" class="btn btn-outline-primary waves-effect">{{ trans("general.Create Account") }}</a>
                </div>
