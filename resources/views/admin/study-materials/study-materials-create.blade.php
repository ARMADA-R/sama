...
<form action="{{ route('admin.studyMaterials.create') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="border-bottom card-header">
            <h4 class="card-title">{{ trans('general.create_studyMaterials') }}</h4>
        </div>
        <div class="card-body">
            <div class="row pt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="mb-1">
                                ...
                                <input required type="number" name="min_grade" id="min_grade" class="form-control" value="{{old('min_grade')? old('min_grade') : ''}}">
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="max_grade">{{ trans('general.max_grade') }}</label>
                                <input required type="number" name="max_grade" id="max_grade" class="form-control" value="{{old('max_grade')? old('max_grade') : ''}}">
                                </div>
                        </div>
                    </div>
                </div>
