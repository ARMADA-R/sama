        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">{{ trans("general.studyMaterials") }}</h4>
                    <a href="{{ route('admin.studyMaterials.create') }}" class="btn btn-outline-primary waves-effect">{{ trans("general.create_studyMaterials") }}</a>
                </div>
