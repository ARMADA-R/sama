<div class="demo-inline-spacing justify-content-around ">
    ...
    <!-- Edit guidanceCounselor btn -->

    <a type="button" class="btn btn-sm btn-info action-row" title="{{trans('general.edit')}}" style="margin: 0px;" id="edit_{{ $id }}" href="{{route('admin.guidanceCounselors.update',$id) }}">
...
<form role="form" id="accountStatus-{{ $id }}" action="{{ route('admin.guidanceCounselors.update.status', $id) }}" method="POST">
    @csrf
