        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">{{ trans("general.guidance_counselors") }}</h4>
                    <a href="{{ route('admin.guidanceCounselors.create') }}" class="btn btn-outline-primary waves-effect">{{ trans("general.Create Account") }}</a>
                </div>
