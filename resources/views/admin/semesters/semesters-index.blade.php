        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">{{ trans("general.semesters") }}</h4>
                    <a href="{{ route('admin.semesters.create') }}" class="btn btn-outline-primary waves-effect">{{ trans("general.create_semester") }}</a>
                </div>
