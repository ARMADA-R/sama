...
<form action="{{ route('admin.students.create') }}" method="post">
    ...
    <div class="card">
        <div class="border-bottom card-header">
            <h4 class="card-title">{{ trans('general.add_student') }}</h4>
            <div>
    ...
    <div class="card">
        ...
        <div class="card-body  mb-2">
            <div class="row pt-2">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="username">{{ trans('general.nationality') }}</label>
                        <select required name="nationality" class="form-select" id="nationality">
                            <option value="">--</option>
                            @foreach($nationalities as $nationality)
                            <option value="{{ $nationality->id }}" {{ old('nationality')? ($nationality->id == old('nationality')? 'selected':'') : ''}}>{{ $nationality->title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <input required type="text" name="birth_place" class="form-control" id="birth_place" value="{{old('birth_place')? old('birth_place') : ''}}">
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="birth_date">{{ trans('general.birth_date') }}</label>
                        <input type="text" name="birth_date" id="birth_date" class="form-control flatpickr-basic" value="{{old('birth_date')? old('birth_date') : ''}}" placeholder="YYYY-MM-DD" />
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <select required name="religion" class="form-select" id="religion">
                            ...
                            <option value="{{ $religion->id }}" {{ old('religion')? ($religion->id == old('religion')? 'selected':'') : ''}}>{{ $religion->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="demo-inline-spacing justify-content-around">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="addMotherType" id="exist-mother-account" value="0" {{ old('addMotherType')? ('0' == old('addMotherType')? 'checked':'') : 'checked'}}>
                <label class="form-check-label" for="exist-mother-account">حساب موجود سابقاً</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="addMotherType" id="new-mother-account" value="1" {{ old('addMotherType')? ('1' == old('addMotherType')? 'checked':'') : ''}}>
        ...
        <div class="card-body">
            ...
            <div class="row pt-2">
                <input type="hidden" name="exest_mother_id" id="mother_id" value="{{old('exest_mother_id')? old('exest_mother_id') : ''}}">
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="mother_fname">{{ trans('general.First Name') }}</label>
                        <input disabled required type="text" name="mother_firstName" class="form-control" id="mother_fname" value="{{old('mother_firstName')? old('mother_firstName') : ''}}">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="mother_lname">{{ trans('general.Last Name') }}</label>
                        <input disabled required type="text" name="mother_lastName" class="form-control" id="mother_lname" value="{{old('mother_lastName')? old('mother_lastName') : ''}}">
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <input disabled required type="text" name="mother_job" class="form-control" id="mother_job" value="{{old('mother_job')? old('mother_job') : ''}}">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="mother_phone">{{ trans('general.phone') }}</label>
                        <input disabled required type="text" name="mother_phone" class="form-control" id="mother_phone" value="{{old('mother_phone')? old('mother_phone') : ''}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="demo-inline-spacing justify-content-around">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="addFatherType" id="exist-father-account" value="0" {{ old('addFatherType')? ('0' == old('addFatherType')? 'checked':'') : 'checked'}}>
                <label class="form-check-label" for="exist-father-account">حساب موجود سابقاً</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="addFatherType" id="new-father-account" value="1" {{ old('addFatherType')? ('1' == old('addFatherType')? 'checked':'') : ''}}>
        ...
        <div class="card-body mb-2">
            ...
            <div class="row pt-2">
                <input type="hidden" name="exest_father_id" id="father_id" value="{{old('exest_father_id')? old('exest_father_id') : ''}}">
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="father_fname">{{ trans('general.First Name') }}</label>
                        <input disabled required type="text" name="father_firstName" class="form-control" id="father_fname" value="{{old('father_firstName')? old('father_firstName') : ''}}">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="father_lname">{{ trans('general.Last Name') }}</label>
                        <input disabled required type="text" name="father_lastName" class="form-control" id="father_lname" value="{{old('father_lastName')? old('father_lastName') : ''}}">
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <input disabled required type="text" name="father_job" class="form-control" id="father_job" value="{{old('father_job')? old('father_job') : ''}}">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-md-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="father_phone">{{ trans('general.phone') }}</label>
                        <input disabled required type="text" name="father_phone" class="form-control" id="father_phone" value="{{old('father_phone')? old('father_phone') : ''}}">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="row px-2">
            ...
            <div class="col-sm-4 col-6  mt-1 text-nowrap">
                <input class="form-check-input" type="radio" name="transportation" id="trans-subscriber" value="1" {{ old('transportation')? ('1' == old('transportation')? 'checked':'') : ''}}>
                <label class="form-check-label" for="trans-subscriber">{{trans("general.subscriber")}}</label>
            </div>
            <div class="col-sm-4 col-6  mt-1 text-nowrap">
                <input class="form-check-input" type="radio" name="transportation" id="trans-non-subscriber" value="0" {{ old('transportation')? ('0' == old('transportation')? 'checked':'') : 'checked'}}>
            ...
            <div class="row pt-2">
                <div class="col-xl-6 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <select required name="city" class="form-select" id="city">
                            ...
                            <option value="{{ $city->id }}" {{ old('city')? ($city->id == old('city')? 'selected':'') : ''}}>{{ $city->title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <input required type="text" name="area" class="form-control" id="area" value="{{old('area')? old('area') : ''}}">
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="mb-1">
                        ...
                        <textarea required name="street" id="street" class="form-control" rows="3">{{old('street')? old('street') : ''}}</textarea>
                    </div>
                </div>
            ...
            <div class="row pt-2">
                <div class="col-sm-6 col-12">
                    <div class="mb-1">
                        ...
                        <input required type="text" name="emergency_phone" class="form-control" id="emergency_phone" value="{{old('emergency_phone')? old('emergency_phone') : ''}}">
                    </div>
                </div>
                <div class="col-sm-6 col-12">
                    <div class="mb-1">
                        <label class="form-label" for="kinship">{{ trans('general.kinship') }}</label>
                        <input required type="text" name="kinship" class="form-control" id="kinship" value="{{old('kinship')? old('kinship') : ''}}">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        $("input[name='addMotherType']").change(function() {
        ...
        $("input[name='addFatherType']").change(function() {
