<div class="demo-inline-spacing justify-content-around ">
    ...
    <a type="button" class="btn btn-sm btn-info action-row" title="{{trans('general.edit')}}" style="margin: 0px;" id="edit_{{ $id }}" href="{{route('admin.headmasters.update',$id) }}">
...
<form role="form" id="accountStatus-{{ $id }}" action="{{ route('admin.headmasters.update.status', $id) }}" method="POST">
    @csrf
