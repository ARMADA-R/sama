...
<head>
    ...
    <title>Login Page | Guidance</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">Sama | Guidance</h2>
                                </a>

                                
                                <form class="auth-login-form mt-2" action="{{ route('guidance.login') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
