        ...
        <form class="validate-form mt-2 pt-50">
          <div class="row">
            <div class="col-12 col-sm-6 mb-1">
              ...
              <input type="text" class="form-control" id="accountFirstName" name="firstName" placeholder="John" value="{{ Auth::guard('headmaster')->user()->first_name }}" data-msg="Please enter first name" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountLastName">{{ trans("general.Last Name") }}</label>
              <input type="text" class="form-control" id="accountLastName" name="lastName" placeholder="Doe" value="{{ Auth::guard('headmaster')->user()->last_name }}" data-msg="Please enter last name" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountEmail">{{ trans("general.Email") }}</label>
              <input type="email" class="form-control" id="accountEmail" name="email" placeholder="Email" value="{{ Auth::guard('headmaster')->user()->email }}" />
            </div>
            <div class="col-12 col-sm-6 mb-1">
              <label class="form-label" for="accountUsername">{{ trans("general.Username") }}</label>
              <input type="text" class="form-control" id="accountUsername" name="Username" placeholder="Username" value="{{ Auth::guard('headmaster')->user()->username }}" />
            </div>
