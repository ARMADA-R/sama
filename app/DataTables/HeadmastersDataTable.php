...
class HeadmastersDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('Action', 'admin.headmasters.action')
            ->rawColumns([
                'Action',
            ])
     ...
     *
     * @param \App\Models\Headmaster $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Headmaster $model)
    {
    ...
    {
        return 'Headmasters_' . date('YmdHis');
    }
}
